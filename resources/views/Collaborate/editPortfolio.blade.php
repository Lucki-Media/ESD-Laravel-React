...
@section('content')
    ...
    <form class="row g-3 needs-validatin" method="POST" enctype="multipart/form-data"
        action="{{ url('admin/update_portfolio/' . $portfolio['id']) }}" novalidate>
        @csrf
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3 mb-lg-0">
                                    ...
                                    <select class="form-select" data-choices-search-false id="inputPriority"
                                        name="priority">
                                        <option value="1" @if ($portfolio['priority'] == '1') selected @endif>Portfolio
                                        </option>
                                        <option value="2" @if ($portfolio['priority'] == '2') selected @endif>Archived
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="mb-3 mb-lg-0">
                                    ...
                                    <select class="form-select" data-choices-search-false id="inputStatus"
                                        name="show_details">
                                        <option value="1" @if ($portfolio['show_details'] == '1') selected @endif>Public
                                        </option>
                                        @if ($portfolio['priority'] == '2')
                                            <option value="2" @if ($portfolio['show_details'] == '2') selected @endif>Private
                                            </option>
                                        @endif
                                    </select>
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="choices-multiple-remove-button" data-choices
                                ...
                                @foreach ($parners as $value)
                                    <option value="{{ $value['id'] }}"
                                        {{ in_array($value['id'], $partnerTag) ? 'selected' : '' }}>

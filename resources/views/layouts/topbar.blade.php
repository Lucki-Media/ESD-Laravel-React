            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" id="page-header-notifications-dropdown" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger">{{\App\Models\Communicate::where('read_status', '1')->count()}}<span class="visually-hidden">unread messages</span></span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                        ...
                        <div class="tab-content position-relative" id="notificationItemsTabContent">
                            <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                ...
                                <?php $notifications = \App\Models\Communicate::where('read_status', '1')->get()->toArray();
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-1">
                                                <a href="#!" class="stretched-link">
                                                    <h6 class="mt-0 mb-2 fs-13 lh-base">You have received a message <b class="text-success">{{$value['full_name']}}</b>
                                                    </h6>
                                                </a>
                                                <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                    <span><i class="mdi mdi-clock-outline"></i> {{ Carbon\Carbon::parse($value['created_at'])->diffForHumans() }}</span>
                                                </p>
                                            </div>
                                   ...
                                   <?php  }  ?>
                                    ...
                                    <div class="my-3 text-center view-all">
                                        <a href="{{url('admin/communicate_message')}}" class="btn btn-soft-success waves-effect waves-light">View
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item " href="{{url('logout')}}"><i class="bx bx-power-off text-muted font-size-16 align-middle me-1"></i> <span key="t-logout">@lang('translation.logout')</span></a>
                    </div>
                </div>
            </div>
        </div>

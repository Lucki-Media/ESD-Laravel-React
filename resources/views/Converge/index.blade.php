            ...
            <div class="card-header align-items-center d-flex">
                ...
                <div class="flex-shrink-0">
                    <div class="form-check form-switch form-switch-right form-switch-md">
                        <a href="{{url('admin\update_heading').'/converge'}}" class="btn btn-primary "><i
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                ...
                <div class="flex-shrink-0">
                    <div class="form-check form-switch form-switch-right form-switch-md">
                        <a href="{{url('admin\add_converge_topic')}}" class="btn btn-primary "><i
                                ...
                                <tr class="align-top">
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <div class="edit">
                                                <a href="{{url('admin/edit_topic/'.$topic['topic_id'])}}"
                                                    class="btn btn-sm btn-primary edit-item-btn">Edit</a>
                                            </div>
                                            <div class="remove">
                                                <a href="{{url('admin/delete_topic/'.$topic['topic_id'])}}"

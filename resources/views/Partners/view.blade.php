            ...
            <div class="col">
                <div class="p-2">
                    ...
                    <div class="hstack text-white-50 gap-1">
                        <div class="me-2"><i
                                class="ri-building-line me-1 text-white-75 fs-16 align-middle"></i>{{ $data['location'] }}
                        </div>
                        <div><i
                                class="ri-map-pin-user-line me-1 text-white-75 fs-16 align-middle"></i>{{ $data['country'] }}
                        </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-wrap gap-2">
                                            @if ($data['git'] != '')
                                                <div>
                                                    <a href="https://github.com/{{ $data['git'] }}" target="_blank"
                                        ...
                                        <div class="d-flex flex-wrap gap-2 fs-15">
                                            ...
                                            @foreach ($serviceTag as $value)
                                                <div class="badge badge-soft-primary">
                                                    {{ \App\Models\ServiceLinks::where('id', $value)->value('title') }}
                                                </div>
                                            @endforeach
                                        </div>
                                    </div><!-- end card body -->
                                                                        ...
                                                                        <div class="d-flex">
                                                                            <div
                                                                                ...
                                                                                <p class="text-muted text-truncate mb-0">
                                                                                    Year : <span
                                                                                        class="fw-semibold text-dark">{{ $project['year'] }}</span>
                                                                                </p>
                                                                            </div>
                                                                            <div class="flex-shrink-0 ms-2">
                                                                                ...
                                                                                <!-- Inprogress</div> -->
                                                                                <div
                                                                                    class="badge fs-10 badge-soft-{{ $project['priority'] == '1' ? 'success' : 'primary' }}">
                                                                                    <span
                                                                                        class="">{{ $project['priority'] == '1' ? 'Portfolio' : 'Archive' }}
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="d-flex mt-4">
                                                                                        ...
                                                                                        @if (count($partnerTag) > 0)
                                                                                            @foreach ($partnerTag as $partner)
                                                                                                ...
                                                                                                <div class="avatar-group-item"
                                                                                                    ...
                                                                                                    title="{{ \App\Models\ConvergeLinks::where('id', $partner)->value('partner') }}">
                                                                                                    <div
                                                                                                        class="avatar-xxs">

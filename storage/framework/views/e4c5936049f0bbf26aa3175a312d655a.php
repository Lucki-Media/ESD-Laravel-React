<?php $__env->startSection('title'); ?> Add Link <?php $__env->stopSection(); ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="live-preview">
                    <form class="row g-3 needs-validation" method="POST"  action="<?php echo route('admin.save_converge_link'); ?>" novalidate>
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">

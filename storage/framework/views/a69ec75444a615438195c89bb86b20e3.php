                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps1">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(url('admin\collaborate_portfolio')); ?>" class="nav-link">Portfolio</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps2">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(url('admin\serviceIndex')); ?>" class="nav-link">Services</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(url('admin\serviceLinkIndex')); ?>" class="nav-link">Service Links</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps3">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(url('admin\communicate_message')); ?>" class="nav-link">Messages</a>
                            </li>
                        </ul>
                    </div>
                </li>

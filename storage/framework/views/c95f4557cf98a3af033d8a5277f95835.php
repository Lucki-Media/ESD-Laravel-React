                    ...
                    <table class="table table-borderless align-middle">
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-10.jp')); ?>g" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_7.4\htdocs\ESD-Laravel\resources\views/apps-nft-auction.blade.php ENDPATH**/ ?>
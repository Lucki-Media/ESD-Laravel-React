                        ...
                        <div class="col-lg-4">
                            <div class="mb-3 mb-lg-0">
                                ...
                                <select class="form-select" data-choices-search-false  id="inputStatus" name="show_details">
                                    ...
                                    <?php if($portfolio['priority'] == '2'): ?> <option value="2"  <?php if($portfolio['show_details'] == '1'): ?> selected <?php endif; ?>>Private</option>  <?php endif; ?>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-4">
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
        ...
        $(document).ready(function() {
            ...
            var priority = <?php echo json_encode($portfolio['show_details']); ?>;

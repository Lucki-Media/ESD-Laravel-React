            ...
            <div class="card-body">
                <div class="live-preview">
                    <form class="row g-3 needs-validation" method="POST"
                        action="<?php echo url('admin/update_link/'.$data['id']); ?>" novalidate>
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                            ...
                            <input type='text' name="partner" class="form-control" id="validationCustom01"
                                placeholder="Enter Partner Here..." value="<?php echo e($data['partner']); ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type='text' name="link" class="form-control" id="validationCustom02"
                                placeholder="Enter Link Here..." value="<?php echo e($data['link']); ?>" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-3">
                            ...
                            <input type='text' name="location" class="form-control" id="validationCustom02"
                                placeholder="Enter Location Here..." value="<?php echo e($data['location']); ?>" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="year" placeholder="MM/YY"
                                value="<?php echo e($data['year']); ?>" id="cleave-date-format " required>
                            <div class="invalid-feedback">
